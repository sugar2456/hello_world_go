...
func UserIDIsNil() predicate.Playlist {
	return predicate.Playlist(sql.FieldIsNull(FieldUserID))
}

// UserIDNotNil applies the NotNil predicate on the "user_id" field.
func UserIDNotNil() predicate.Playlist {
	return predicate.Playlist(sql.FieldNotNull(FieldUserID))
}
...
func HasVideos() predicate.Playlist {
	return predicate.Playlist(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasVideosWith(preds ...predicate.Videos) predicate.Playlist {
	return predicate.Playlist(func(s *sql.Selector) {
		step := newVideosStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
